    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-4">
        <div 
          ...
          :key="idx"
          class="grain-card group relative overflow-hidden rounded-2xl bg-panel border border-[var(--border-glass)] transition-all duration-300 hover:border-accent/30"
        >
          <button
            @click="toggleFaq(idx)"
